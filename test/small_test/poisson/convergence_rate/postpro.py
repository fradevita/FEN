...
plt.xlabel("N")
plt.ylabel("error")
plt.title("Convergence rate of the Poisson Solver with Neumann-Neumann BC")
plt.xscale("log")
plt.yscale("log")
plt.xticks(N, N)
plt.legend()
...
plt.xlabel("N")
plt.ylabel("error")
plt.title("Convergence rate of the Poisson Solver with Periodic-Periodic BC")
plt.xscale("log")
plt.yscale("log")
plt.xticks(N, N)
plt.legend()
...
plt.xlabel("N")
plt.ylabel("error")
plt.title("Convergence rate of the Poisson Solver with Periodic-Neumann BC")
plt.xscale("log")
plt.yscale("log")
plt.xticks(N, N)
plt.legend()
...
plt.xlabel("N")
plt.ylabel("error")
plt.title("Convergence rate of the Poisson Solver with Periodic-Periodic-Periodic BC")
plt.xscale("log")
plt.yscale("log")
plt.xticks(N, N)
plt.legend()
...
if (-a > 1.8):
  print('    Test completed for the Periodic-Periodic-Neumann Poisson solver.')
else:
  print('    The convergence rate of the Periodic-Periodic Neumann Poisson solver is less than second order')
...
plt.xlabel("N")
plt.ylabel("error")
plt.title("Convergence rate of the Poisson Solver with Periodic-Periodic-Neumann BC")
plt.xscale("log")
plt.yscale("log")
plt.xticks(N, N)
plt.legend()
