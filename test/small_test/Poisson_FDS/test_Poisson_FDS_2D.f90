program test_Poisson_FDS_2D
   ...
   do n = 1,5
      ...
      do k = base_grid%lo(3), base_grid%hi(3)
         do j = base_grid%lo(2),base_grid%hi(2)
            do i = base_grid%lo(1),base_grid%hi(1)
               phi%f(i,j,k) = -8.0_dp*pi*pi*cos(2.0_dp*pi*base_grid%x(i))*cos(2.0_dp*pi*base_grid%y(j))
            end do
         end do
      end do
      ...
      do k = base_grid%lo(3), base_grid%hi(3)
         do j = base_grid%lo(2),base_grid%hi(2)
            do i = base_grid%lo(1),base_grid%hi(1)
               e = abs(phi%f(i,j,k) - cos(2.0_dp*pi*base_grid%x(i))*cos(2.0_dp*pi*base_grid%y(j)))
               if (e > emax) emax = e
            end do
         end do
      end do
   ...
   ! Second test is with Periodic BC on all boudaries
   bc(1)%s = 'Periodic'
   bc(2)%s = 'Periodic'
   bc(3)%s = 'Periodic'
   bc(4)%s = 'Periodic'
   ...
   do n = 1,5
      ...
      do k = base_grid%lo(3), base_grid%hi(3)
         do j = base_grid%lo(2),base_grid%hi(2)
            do i = base_grid%lo(1),base_grid%hi(1)
               phi%f(i,j,k) = -8.0_dp*pi*pi*sin(2.0_dp*pi*base_grid%x(i))*cos(2.0_dp*pi*base_grid%y(j))
            end do
         end do
      end do
      ...
      do k = base_grid%lo(3), base_grid%hi(3)
         do j = base_grid%lo(2),base_grid%hi(2)
            do i = base_grid%lo(1),base_grid%hi(1)
               e = abs(phi%f(i,j,k) - sin(2.0_dp*pi*base_grid%x(i))*cos(2.0_dp*pi*base_grid%y(j)))
               if (e > emax) emax = e
            end do
         end do
      end do
   ...
   ! Third test is with Periodic-Neumann BC in x-y directions
   bc(1)%s = 'Periodic'
   bc(2)%s = 'Periodic'
   bc(3)%s = 'Wall'
   bc(4)%s = 'Wall'
   ...
   do n = 1,5
      ...
      do k = base_grid%lo(3), base_grid%hi(3)
         do j = base_grid%lo(2),base_grid%hi(2)
            do i = base_grid%lo(1),base_grid%hi(1)
               phi%f(i,j,k) = -4.0_dp*pi*pi*(sin(2.0_dp*pi*base_grid%x(i)) + cos(2.0_dp*pi*base_grid%y(j)))
            end do
         end do
      end do
