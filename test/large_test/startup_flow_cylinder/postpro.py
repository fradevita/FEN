...
plt.plot( KL[:,0]/ ,                KL[:,1], 'o', label = 'K and L. 1995')
plt.plot(KLf[:,0]/2,               KLf[:,1], 'x', label = 'friction, K and L. 1995')
plt.plot(KLp[:,0]/2,               KLp[:,1], 'v', label = 'pressure, K and L. 1995')
plt.plot( DATA[:,0],             -DATA[:,1],      label = 'FEN Cd', color = 'black')
plt.plot( DATA[:,0],              DATA[:,2],      label = 'FEN viscous', color = 'blue')
plt.plot( DATA[:,0],              DATA[:,3],      label = 'FEN pressure', color = 'red')
plt.plot( DATA[:,0],  DATA[:,2] + DATA[:,3],      label = 'FEN Cd', color = 'black')
plt.legend()
plt.show()
plt.close()
