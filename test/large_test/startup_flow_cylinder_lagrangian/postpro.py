...
plt.plot( DATA["t"], DATA["Fsy"],      label = 'FEN viscous', color = 'blue')
plt.plot( DATA["t"], DATA["Fpy"],      label = 'FEN pressure', color = 'red')
plt.plot( DATA["t"],  DATA["Fy"],      label = 'FEN Cd', color = 'black')
plt.legend()
plt.show()
plt.close()
