...
contains
    ...
    !===============================================================================================
    subroutine face_to_center(sf, sc, face)

        type(scalar)    , intent(in   ) :: sf   ! input scalar on face
        type(scalar)    , intent(inout) :: sc   ! output scalar on center
        character(len=1), intent(in   ) :: face ! face where the face scalar is defined
        ...
        select case(face)
            case('x')
                ...
                do k = sc%G%lo(3),sc%G%hi(3)
                    do j = sc%G%lo(2),sc%G%hi(2)
                        do i = sc%G%lo(1),sc%G%hi(1)
                            sc%f(i,j,k) = 0.5_dp*(sf%f(i,j,k) + sf%f(i-1,j,k))
                        end do
                    end do
                end do
            ...
            case('y')
                ...
                do k = sc%G%lo(3),sc%G%hi(3)
                    do j = sc%G%lo(2),sc%G%hi(2)
                        do i = sc%G%lo(1),sc%G%hi(1)
                            sc%f(i,j,k) = 0.5_dp*(sf%f(i,j,k) + sf%f(i,j-1,k))
                        end do
                    end do
                end do
            ...
            case('z')
                ...
                do k = sc%G%lo(3),sc%G%hi(3)
                    do j = sc%G%lo(2),sc%G%hi(2)
                        do i = sc%G%lo(1),sc%G%hi(1)
                            sc%f(i,j,k) = 0.5_dp*(sf%f(i,j,k) + sf%f(i,j,k-1))
                        end do
                    end do
                end do
